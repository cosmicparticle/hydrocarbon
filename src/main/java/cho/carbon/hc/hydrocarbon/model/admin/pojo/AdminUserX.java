...
public class AdminUserX implements UserDetails, UserIdentifier{
	...
	public Collection<? extends GrantedAuthority> getAuthorities() {
		...
		if(this.authorityChain != null){
			String[] split = this.authorityChain.split(HydrocarbonConstants.COMMON_SPLITER);
	...
	public boolean isAccountNonExpired() {
		return HydrocarbonConstants.VALUE_TRUE.equals(accountNonExpired);
	}

	@Override
	public boolean isAccountNonLocked() {
		return HydrocarbonConstants.VALUE_TRUE.equals(accountNonLocked);
	}

	@Override
	public boolean isCredentialsNonExpired() {
		return HydrocarbonConstants.VALUE_TRUE.equals(credentialsNonExpired);
	}

	@Override
	public boolean isEnabled() {
		return HydrocarbonConstants.VALUE_TRUE.equals(enabled);
	}
