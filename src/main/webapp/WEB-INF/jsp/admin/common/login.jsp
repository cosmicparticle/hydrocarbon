...
<link href="media/admin/plugins/beyond/css/bootstrap.min.css"
	rel="stylesheet" />
...
#submit {
	...
	color: #ffffff;
	border-radius: 0.21em;
	box-shadow: inset 0 1px 0 rgba(255, 255, 255, .08), 0 1px 0
		rgba(255, 255, 255, .3);
		...
		<div class="Z-login-container">
			<div class="Z-loginbox">
				...
				<div class="loginbox-info">
					<input type="text" name="ddxy-admin-username" id="userName"
						placeholder="用户名" /> <input type="password"
						name="ddxy-admin-password" id="userWord" placeholder="密码" />
				</div>
	...
	$(function() {
		window.onload = function() {
			...
			if (warnInfo.length === 0) {
				...
				loginBox.attr('style',
						'transition:none;margin-top:-200px;opacity:1');
			}
